...
<style lang="scss">
	...
	main::after {
		right: 0;
		top: 0;
		background-image: radial-gradient(at 100% 15%, hsla(147, 29%, 49%, 0.2) 0px, transparent 50%);
	}
	...
	@media only screen and (max-width: $tablet) {
		...
		main::before {
			background-image: radial-gradient(at 0% 100%, hsla(170, 29%, 49%, 0.1) 0px, transparent 50%);
		}
	}
