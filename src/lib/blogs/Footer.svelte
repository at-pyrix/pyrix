...
<footer>
	<div class="container">
		...
		<div class="social-links">
			...
			<a href="https://t.me/unwantedseventytwo" title="Telegram" rel="noreferrer" target="_blank"><Icon icon="ic:round-telegram" /></a>
...
<style lang="scss">
	footer {
		...
		&::after {
			...
			width: 100%;
			height: 1px;
			background-image: linear-gradient(90deg, rgba(255, 0, 187, 1) 0%, rgba(182, 0, 255, 1) 50%, rgba(255, 173, 0, 1) 100%);
		}
		.container {
			margin: 0 auto;
			max-width: 1225px;
